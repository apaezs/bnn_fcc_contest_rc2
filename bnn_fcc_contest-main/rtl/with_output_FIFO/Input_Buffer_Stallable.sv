...
module Input_Buffer_Stallable #(
    ...
    always_ff @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (stall) begin
                if ((pending_switch_bank == 1'b0 && bank0_empty) || (pending_switch_bank == 1'b1 && bank1_empty)) begin
    ...
    always_comb begin
        if (read_bank_sel_reg0) ostream = ostream_bank1;
        else
