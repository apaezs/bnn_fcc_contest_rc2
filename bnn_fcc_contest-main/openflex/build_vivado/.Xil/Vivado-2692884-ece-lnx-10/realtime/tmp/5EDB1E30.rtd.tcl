...
set genomeRtd $env(RT_TMP)/5EDB1E30.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {NP_Layer_WithThreshold__GB2}]"
...
set genomeName [subst -nocommands -novariables {NP_Layer_WithThreshold__GB2}]
