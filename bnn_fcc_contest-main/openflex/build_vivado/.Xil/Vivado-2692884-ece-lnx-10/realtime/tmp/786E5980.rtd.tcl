...
set genomeRtd $env(RT_TMP)/786E5980.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {bnn_fcc_timing_GT0}]"
...
set genomeName [subst -nocommands -novariables {bnn_fcc_timing_GT0}]
