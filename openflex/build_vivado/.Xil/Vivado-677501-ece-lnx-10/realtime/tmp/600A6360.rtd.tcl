...
set genomeRtd $env(RT_TMP)/600A6360.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {BNN_Layer_StallableInput__GC0}]"
...
set genomeName [subst -nocommands -novariables {BNN_Layer_StallableInput__GC0}]
