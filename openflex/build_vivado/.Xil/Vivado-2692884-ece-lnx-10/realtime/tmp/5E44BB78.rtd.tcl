...
set genomeRtd $env(RT_TMP)/5E44BB78.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Layer_WithThreshold__parameterized0}]"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-2692884-ece-lnx-10/realtime/bnn_fcc_timing_synth.xdc; 
set genomeName [subst -nocommands -novariables {Layer_WithThreshold__parameterized0}]
