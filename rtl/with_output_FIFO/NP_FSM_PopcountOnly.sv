...
module NP_FSM_PopcountOnly #(
  ...
  generate
    if (ALIGN_DELAY == 0) begin : g_align_bypass
  ...
  Delay2_ALWAYS #(
    ...
    .clk       (clk),
    .din       (last_in),
    .dout_tap  (last_aligned),
    .dout_final(last_to_valid_acc)
  );
  ...
  assign pipeline_busy       = valid_aligned_g || last_to_valid_acc_g;
